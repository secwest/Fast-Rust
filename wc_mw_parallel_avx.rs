...
// wc -mw Unicode and ASCII character and word counting optimized in Rust using Rayon for parallelization, and AVX SIMD optimization on each core if AVX2 or AVX512 are available.
...
unsafe fn count_patterns_avx2_chunk(chunk_ptr: *const u8) -> ChunkResult {
    ...
    let is_two_byte_utf_mask = (((_mm256_movemask_epi8(_mm256_cmpeq_epi8(
        _mm256_and_si256(chunk_data2, _mm256_set1_epi8(0b11100000u8 as i8)), _mm256_set1_epi8(0b11000000u8 as i8)))) as u64)
        << 32) | ((_mm256_movemask_epi8(_mm256_cmpeq_epi8(
        _mm256_and_si256(chunk_data1, _mm256_set1_epi8(0b11100000u8 as i8)), _mm256_set1_epi8(0b11000000u8 as i8)))) as u64);
    ...
    let is_four_byte_utf_mask = (((_mm256_movemask_epi8(_mm256_cmpeq_epi8(
        _mm256_and_si256(chunk_data2, _mm256_set1_epi8(0b11111000u8 as i8)), _mm256_set1_epi8(0b11110000u8 as i8)))) as u64)
        << 32) | ((_mm256_movemask_epi8(_mm256_cmpeq_epi8(
        _mm256_and_si256(chunk_data1, _mm256_set1_epi8(0b11111000u8 as i8)), _mm256_set1_epi8(0b11110000u8 as i8)))) as u64);
...
unsafe fn count_patterns_avx512_chunk(chunk_ptr: *const u8) -> ChunkResult {
    ...
    // Apply masks and perform UTF sequence comparisons
    let is_two_byte_utf_mask = _mm512_cmpeq_epi8_mask(_mm512_and_si512(chunk_data, _mm512_set1_epi8(0b11100000)), _mm512_set1_epi8(0b11000000)) as u64;
    ...
    let is_four_byte_utf_mask = _mm512_cmpeq_epi8_mask(_mm512_and_si512(chunk_data, _mm512_set1_epi8(0b11111000)), _mm512_set1_epi8(0b11110000)) as u64;
